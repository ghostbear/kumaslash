...
import me.ghostbear.kumaslash.tachiyomi.local.ExtensionRepository;
import me.ghostbear.kumaslash.tachiyomi.local.SourceRepository;
import me.ghostbear.kumaslash.tachiyomi.local.model.Extension;
import me.ghostbear.kumaslash.tachiyomi.local.model.Source;
import me.ghostbear.kumaslash.tachiyomi.remote.TachiyomiRepository;
import me.ghostbear.kumaslash.tachiyomi.util.ExtensionMapper;
...
public class TachiyomiExtensionService {
	...
	private final TachiyomiRepository tachiyomiRepository;

	@Autowired
	public TachiyomiExtensionService(ExtensionRepository extensionRepository, SourceRepository sourceRepository, TachiyomiRepository tachiyomiRepository) {
		this.extensionRepository = extensionRepository;
		this.sourceRepository = sourceRepository;
		this.tachiyomiRepository = tachiyomiRepository;
	}

	public Mono<Void> update() {
		return tachiyomiRepository.getExtensions()
